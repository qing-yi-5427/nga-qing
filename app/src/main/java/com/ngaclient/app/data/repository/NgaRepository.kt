...
import com.ngaclient.app.data.local.AppDatabase
import com.ngaclient.app.data.local.FavoriteEntity
import com.ngaclient.app.data.local.FavoriteBoardEntity
import com.ngaclient.app.data.local.HistoryEntity
import com.ngaclient.app.data.local.UserPreferences
import com.ngaclient.app.data.model.Board
import com.ngaclient.app.data.model.BoardGroup
import com.ngaclient.app.data.model.Post
import com.ngaclient.app.data.model.PostComment
import com.ngaclient.app.data.model.PostPage
import com.ngaclient.app.data.model.ThreadItem
import com.ngaclient.app.data.model.ThreadPage
 ...
 * All network responses are GBK-decoded Strings (see [com.ngaclient.app.data.remote.GbkConverterFactory]).
 */
@Singleton
class NgaRepository @Inject constructor(
     ...
     * 同时落盘到内部存储 /data/data/com.ngaclient.app/files/ 作为后备（adb shell run-as 可读）。
